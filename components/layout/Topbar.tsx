...
export function Topbar() {
  ...
  return (
    <header className="flex h-16 shrink-0 items-center gap-3 bg-white border-b border-slate-200 px-5">
      <div className="flex items-center gap-2.5">
        <SidebarTrigger className="-ml-1 h-8 w-8 text-slate-500 hover:text-slate-700 hover:bg-slate-100" />
